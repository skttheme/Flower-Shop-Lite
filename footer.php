    	...
    	<div class="container footer">
         ...
         <div class="copyright-wrapper">
        	<div class="container">
            	 ...
            	 <div class="design-by"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','flower-shop-lite');?><a href="<?php echo esc_url('https://www.sktthemes.org/product-category/ecommerce-wordpress-themes/');?>" target="_blank">
        <?php esc_html_e('SKT eCommerce Themes','flower-shop-lite'); ?>
        </a></div>
                 <div class="clear"></div>
            </div>           
        </div>
